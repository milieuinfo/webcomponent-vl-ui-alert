// Variables
$vl-alert-padding: 2rem;
$vl-alert-padding-small: 1.5rem;
$vl-alert-padding-large: 5rem 5.5rem;
...
.vl-alert {
  ...
  font-size: 1.6rem;
  line-height: 1.4;
  border: 0.1rem solid $vl-alt-bg;
  padding: $vl-alert-padding;
  margin-bottom: $vl-spacing-small;

  @include respond-to(small) {
    font-size: 1.4rem;
    padding: $vl-alert-padding-small;
  }
  ...
  &__icon {
    ...
    flex: 0 0 auto;
    background: $vl-white;
    margin-right: $vl-alert-padding;

    @include respond-to(small) {
      margin-right: $vl-alert-padding-small;
    }
  ...
  &--cta {
    border: 0;
    border-top: 0.3rem solid $vl-action-color;
  }
  ...
  // Large
  &--large {
    padding: $vl-alert-padding-large;
